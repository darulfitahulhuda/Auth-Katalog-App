...
/// Create a copy of Failure
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? message = null,Object? stackTrace = null,}) {
...
switch (_that) {
case ServerFailure() when server != null:
return server(_that.message,_that.stackTrace);case NetworkFailure() when network != null:
return network(_that.message,_that.stackTrace);case CacheFailure() when cache != null:
return cache(_that.message,_that.stackTrace);case UnexpectedFailure() when unexpected != null:
...
switch (_that) {
case ServerFailure():
return server(_that.message,_that.stackTrace);case NetworkFailure():
return network(_that.message,_that.stackTrace);case CacheFailure():
return cache(_that.message,_that.stackTrace);case UnexpectedFailure():
return unexpected(_that.message,_that.stackTrace);}
}
...
class ServerFailure implements Failure {
  const ServerFailure([this.message = 'A server error occurred', this.stackTrace = StackTrace.empty]);
...
/// Create a copy of Failure
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? message = null,Object? stackTrace = null,}) {
...
class NetworkFailure implements Failure {
  const NetworkFailure([this.message = 'No network connection', this.stackTrace = StackTrace.empty]);
...
class CacheFailure implements Failure {
  const CacheFailure([this.message = 'A cache error occurred', this.stackTrace = StackTrace.empty]);
...
class UnexpectedFailure implements Failure {
  const UnexpectedFailure([this.message = 'An unexpected error occurred', this.stackTrace = StackTrace.empty]);
